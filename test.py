...
dataset = 'GRIP'#CoMoFoD  USCISI-CMFD  CASIA
test_save_dir = './test_saved/0508' + dataset
test_vis_dir = './test_vis/0508' + dataset + '/'#train/'
...
def main():
    ...
    model.load_state_dict(torch.load('./train_saved/0506/380000.pth'))

    model.eval()
    model.cuda()
    # TrainDataset(mode='train')
