...
def main():
    ...
    model0.load_state_dict(torch.load('./train_saved/0613/110000.pth'))
    model0.eval()
    model0.cuda()
    ...
    for i_iter, batch_data in enumerate(dataloader):
        ...
        pred_flux0 = model0(Input_image.cuda())

        pred_flux = nn.Sigmoid()(pred_flux0)
