...
from SuperBPD_vis_flux import vis_flux
from SuperBPD_datasets import FluxSegmentationDataset
...
EPOCHES = 10000
DATASET = 'BSDS500'
SNAPSHOT_DIR = './SuperBPD_saved/'
TRAIN_DEBUG_VIS_DIR = './SuperBPD_train_debug_vis/'
