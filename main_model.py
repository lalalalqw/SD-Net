...
class VGG16(nn.Module):
    def __init__(self):
        ...
        self.refine = nn.Sequential(nn.Conv2d(256, 512, kernel_size=3, padding=1),
                                  nn.ReLU(inplace=True),
                                  nn.Conv2d(512, 512, kernel_size=3, padding=1),
                                  nn.ReLU(inplace=True),
    ...
    def forward(self, x, x_seg, x_norm):
